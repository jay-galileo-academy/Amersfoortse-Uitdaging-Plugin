 ...
 * Update URI:        https://github.com/jay-galileo-academy/Amersfoortse-Uitdaging-Plugin
    ...
    function update() {
        ...
        if ( is_admin() ) {
            ...
            $config = array(
                ...
                'zip_url' => 'https://github.com/jay-galileo-academy/Amersfoortse-Uitdaging-Plugin/archive/master.zip',
                'sslverify' => true,
                'requires' => '3.0',
                'tested' => '3.3',
                'readme' => 'README.md',
